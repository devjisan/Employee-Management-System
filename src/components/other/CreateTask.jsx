...
const CreateTask = () => {
  return (
    <div className='p-5 bg-[#1c1c1c] mt-7 rounded'>
            <form className='flex-wrap flex items-start justify-between w-full '>
                <div className='w-1/2'>
                    <div>
                ...
                <div className='w-1/2 flex flex-col items-start'>
                    ...
                    <textarea className='h-44 w-full text-sm py-2 px-4 rounded outline-none bg-transparent border-[1px] border-gray-400'  name="" id="" cols='30' rows='10'></textarea>
                    <button className='bg-emerald-500 py-3 hover:bg-emerald-60 px-5 rounded text-sm mt-4 w-full '>Create Task</button>
                </div>
